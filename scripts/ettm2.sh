...
do
if [ $model = 'PSW-I' ];then
python benchmark.py --lr 0.01 --batch_size 256 --dataset ETT_m2 --n_epochs 200 --seq_length 24 --distance fft --ratio $ratio --device cuda:3  --ot_type uot_mm --reg_m 1 --dropout 0
else
