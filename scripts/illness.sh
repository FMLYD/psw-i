...
do
if [ $model = 'PSW-I' ];then
python benchmark_sinkhornfft_val.py --lr 0.001 --n_epochs 200 --seq_length 24 --distance fft --dataset illness --batch_size 16 --ratio $ratio  --ot_type uot_mm --device cuda:4
else
